...
import { createSaleController, listSalesController, getSaleController, createRefundController } from '../controllers/salesController.js';

const salesRouter = Router();

salesRouter.post('/', authenticate, validateSale, createSaleController);
salesRouter.post('/:saleId/refund', authenticate, createRefundController);
